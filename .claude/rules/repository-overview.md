...
`dockerhub/repository-overview-copy.md` is the Docker Hub overview for `sesopenko/mcp-media-library-manager`.
...
- The Docker Compose example must use the published image (`sesopenko/mcp-media-library-manager:latest`), not a local build reference
